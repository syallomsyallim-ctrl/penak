...
// Atur volume default (misal 30% saja biar tidak terlalu keras)
music.volume = 0.3;
...
musicBtn.addEventListener('click', () => {
    if (music.paused) {
        ...
        musicBtn.innerHTML = '<i class="fa-solid fa-compact-disc"></i>'; // Mengubah ikon jadi piringan berputar
        musicBtn.setAttribute('title', 'Jeda Musik');
    } else {
        music.pause();
        musicBtn.classList.remove('playing');
        musicBtn.innerHTML = '<i class="fa-solid fa-music"></i>'; // Mengubah ikon kembali ke melodi biasa
